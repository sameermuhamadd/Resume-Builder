...
namespace CVBuilder
{
    class StylishTemplate : ATemplate
    {
        public override void Design(Person person, Education sch, Education col, Education uni, WorkHistory work,AdditionalCourse adc)
        {
            ...
            c1.Font.Color = new BaseColor(236, 236, 236);
            c1.Font.SetStyle(0);
            c1.Font.Size = 25;
            ...
            c2.Font.Color = new BaseColor(236, 236, 236);
            c2.Font.SetStyle(0);
            c2.Font.Size = 14;
            ...
            //Console.WriteLine();
            c3.Font.Color = new BaseColor(236, 236, 236);
            c3.Font.SetStyle(1);
            c3.Font.Size = 13;
            ...
            c4.Font.Color = new BaseColor(236, 236, 236);
            c4.Font.SetStyle(2);
            c4.Font.Size = 13;
            //Console.WriteLine();
            ...
            iTextSharp.text.Image jpg = iTextSharp.text.Image.GetInstance(@"C:\Users\Hp-PC\Desktop\temp2.png");
